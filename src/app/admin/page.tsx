  ...
  useEffect(() => {
    const checkAdminAccess = async () => {
      ...
      if (!userData || userData.is_admin !== true) {
        console.log(
          "Admin check - Not admin, is_admin value:",
          userData?.is_admin
        );
        router.push("/dashboard");
        return;
  ...
  const calculateStats = (users: User[], progress: UserProgress[]) => {
    ...
    const stats: AdminStats = {
      ...
      activeUsers: users.filter(
        (u) => new Date(u.updated_at || u.created_at) > thirtyDaysAgo
      ).length,
      completedAssessments: progress.reduce((sum, p) => {
        ...
        console.log(
          `User ${p.user_id} completed ${userCompletedCount} assessments`
        );
      ...
      averageSPI:
        progress.length > 0
          ? Math.round(
              progress.reduce((sum, p) => sum + (p.spi_score || 0), 0) /
                progress.length
            )
          : 0,
      tierDistribution: {
      ...
      recentSignups: users.filter((u) => new Date(u.created_at) > thirtyDaysAgo)
        .length,
      assessmentCompletion: {
        financial_foundation: progress.filter(
          (p) => p.financial_foundation_completed
        ).length,
        market_intelligence: progress.filter(
          (p) => p.market_intelligence_completed
        ).length,
        personal_strengths: progress.filter(
          (p) => p.personal_strengths_completed
        ).length,
        risk_management: progress.filter((p) => p.risk_management_completed)
          .length,
        support_systems: progress.filter((p) => p.support_systems_completed)
          .length,
      },
    };
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="bg-gradient-to-r from-[#1e3a8a] to-[#1e40af] rounded-lg shadow-lg p-8 text-white">
            ...
            <p className="text-blue-100">
              Monitor user progress, track engagement, and manage the Road to 1%
              community
            </p>
          </div>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-3xl font-bold text-gray-600">
                      {stats.tierDistribution["90%"]}
                    </div>
                    <div className="text-sm text-gray-600">90% Tier</div>
                    <div className="text-xs text-gray-500">
                      Struggling (Drivers & O/Os)
                    </div>
                  </div>
                  <div className="text-center p-4 bg-yellow-50 rounded-lg">
                    <div className="text-3xl font-bold text-[#f59e0b]">
                      {stats.tierDistribution["9%"]}
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#1e3a8a]">
                      {stats.assessmentCompletion.financial_foundation}
                    </div>
                    <div className="text-sm text-gray-600">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#1e40af]">
                      {stats.assessmentCompletion.market_intelligence}
                    </div>
                    <div className="text-sm text-gray-600">
                      Market Intelligence
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#3b82f6]">
                      {stats.assessmentCompletion.personal_strengths}
                    </div>
                    <div className="text-sm text-gray-600">
                      Personal Strengths
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#6366f1]">
                      {stats.assessmentCompletion.risk_management}
                    </div>
                    <div className="text-sm text-gray-600">Risk Management</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#8b5cf6]">
                      {stats.assessmentCompletion.support_systems}
                    </div>
                      ...
                      <tr key={user.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <span
                              className={`ml-2 text-sm font-medium ${getStatusColor(completionPercentage)}`}
                            >
              ...
              {loadingUserDetails ? (
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-900">
                          {selectedUserDetails.progress?.current_tier ||
                            "Not Assigned"}
                        </p>
                      </div>
                      <div>
                  ...
                  <div className="bg-white border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {[
                        ...
                        const completed =
                          selectedUserDetails.progress?.[`${key}_completed`];
                        const score =
                          selectedUserDetails.progress?.[`${key}_score`];
                        return (
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedUserDetails.progress.standout_role_1 ||
                              "N/A"}
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedUserDetails.progress.standout_role_2 ||
                              "N/A"}
                          </p>
                        </div>
                        <div>
                    ...
                    <div className="bg-green-50 p-4 rounded-lg">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            ...
                            {(
                              ...
                              (selectedUserDetails.spiAssessment.investments ||
                                0) +
                              (selectedUserDetails.spiAssessment.retirement ||
                                0) +
                              (selectedUserDetails.spiAssessment.real_estate ||
                                0) +
                              (selectedUserDetails.spiAssessment.vehicles ||
                                0) +
                              (selectedUserDetails.spiAssessment.equipment ||
                                0) +
                              (selectedUserDetails.spiAssessment.other_assets ||
                                0) -
                              (selectedUserDetails.spiAssessment.credit_cards ||
                                0) -
                              (selectedUserDetails.spiAssessment.auto_loans ||
                                0) -
                              (selectedUserDetails.spiAssessment.mortgage ||
                                0) -
                              (selectedUserDetails.spiAssessment
                                .equipment_loans || 0) -
                              (selectedUserDetails.spiAssessment
                                .personal_loans || 0) -
                              (selectedUserDetails.spiAssessment.other_debts ||
                                0)
                            ).toLocaleString()}
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            $
                            {selectedUserDetails.spiAssessment.monthly_income?.toLocaleString() ||
                              "N/A"}
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            $
                            {selectedUserDetails.spiAssessment.monthly_expenses?.toLocaleString() ||
                              "N/A"}
                          </p>
                        </div>
                        <div>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">
                    No detailed assessment data available for this user.
                  </p>
                </div>
              )}
