        ...
        <div className="bg-gray-800 border border-gray-700 rounded-2xl shadow-xl p-8">
          <div className="mb-6">
            ...
            <p className="text-gray-400">
              Use this tool to manually verify users who are having trouble with
              email confirmation. This will allow them to log in immediately.
            </p>
          </div>
          ...
          <div className="mt-8 p-4 bg-gray-900 rounded-xl border border-gray-700">
            ...
            <ul className="text-sm text-gray-500 space-y-1">
              ...
              <li>
                • The user will be able to log in immediately after verification
              </li>
              <li>
                • Use this only for users you trust or have verified through
                other means
              </li>
