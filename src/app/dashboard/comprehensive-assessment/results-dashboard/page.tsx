...
function TruckDashboardResultsContent() {
  ...
  const getProbabilityData = (score: number) => {
    if (score >= 85)
      return {
        percentage: 85 + Math.floor(((score - 85) / 15) * 15),
        status: "Optimal",
      };
    if (score >= 70)
      return {
        percentage: 70 + Math.floor(((score - 70) / 15) * 15),
        status: "Good",
      };
    if (score >= 50)
      return {
        percentage: 50 + Math.floor(((score - 50) / 20) * 20),
        status: "Fair",
      };
    if (score >= 30)
      return {
        percentage: 30 + Math.floor(((score - 30) / 20) * 20),
        status: "Needs Work",
      };
    return {
      percentage: 10 + Math.floor((score / 30) * 20),
      status: "Critical",
    };
  };
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">
                  TRUCK OWNER READINESS DASHBOARD
                </h1>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span
                  className={`font-semibold mt-2 ${
                    probability.status === "Optimal"
                      ? "text-green-400"
                      : probability.status === "Good"
                        ? "text-blue-400"
                        : probability.status === "Fair"
                          ? "text-yellow-400"
                          : "text-red-400"
                  }`}
                >
                  ...
                  <div
                    className={`w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-2 ${
                      status === "good"
                        ...
                        : status === "warning"
                          ? "bg-yellow-900 border-2 border-yellow-500 animate-pulse"
          ...
          <div className="bg-gray-800 rounded-2xl p-6 border-2 border-gray-700 shadow-2xl">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-700">
                ...
                <span className="text-white font-semibold">
                  {tier === "90%"
                    ? `${70 - totalScore} points`
                    : tier === "9%"
                      ? `${85 - totalScore} points`
                      : "Destination Reached"}
                </span>
              </div>
                  ...
                  <div key={dim.name} className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-400 text-sm">
                        Requires immediate attention - Currently at{" "}
