...
export default function ProgressPage() {
  ...
  const totalImprovement =
    latestAssessment.total_spi_score - firstAssessment.total_spi_score;
  const percentageImprovement = (
    (totalImprovement / firstAssessment.total_spi_score) *
    100
  ).toFixed(1);
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Track your improvement over {assessmentHistory.length} assessment
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      <div>
                        ...
                        <p className="font-semibold">
                          {assessment.financial_foundation_score}/35
                        </p>
                      </div>
                      <div>
                        <p className="text-gray-600 dark:text-gray-400">
                        ...
                        <p className="font-semibold">
                          {assessment.market_intelligence_score}/20
                        </p>
                      </div>
                      <div>
                        <p className="text-gray-600 dark:text-gray-400">
                        ...
                        <p className="font-semibold">
                          {assessment.risk_management_score}/15
                        </p>
                      </div>
                      <div>
                        <p className="text-gray-600 dark:text-gray-400">
                        ...
                        <p className="font-semibold">
                          {assessment.support_systems_score}/10
                        </p>
                      </div>
                    </div>
                    <div className="mt-3">
                      ...
                      <p className="font-semibold">
                        {assessment.standout_strength_1} +{" "}
                        {assessment.standout_strength_2}
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          ...
                          <span
                            className={`ml-2 font-semibold ${
                              assessment.total_spi_score >
                              assessmentHistory[index - 1].total_spi_score
                                ? "text-green-600"
                                : assessment.total_spi_score <
                                    assessmentHistory[index - 1].total_spi_score
                                  ? "text-red-600"
